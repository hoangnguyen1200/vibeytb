...
export const VideoScriptSchema = z.object({
  ...
  scenes: z.array(z.object({
    ...
    target_website_url: z.string().nullable().optional().describe("CRITICAL: Prioritize using a YouTube search URL (e.g., https://youtube.com/results?search_query=...) or a public landing page with a demo video. COMPLETELY AVOID any URLs that require login (e.g., chat.openai.com, gamma.app, notion.so). Example: if the scene introduces ChatGPT Custom GPTs, use 'https://youtube.com/results?search_query=chatgpt+custom+gpts+tutorial'."),
